...
\begin{figure}[H]
    ...
    \includegraphics[
        ...
        height=7.26597in,
        keepaspectratio
    ]{images/Use case Diagram của Khách hàng.png}

    \caption{Use Case Diagram khách hàng}
    \label{fig:use-case-khach-hang}
\end{figure}

\begin{longtable}{|L{3cm}|L{11cm}|}

\caption{Mô tả Use Case Đăng ký tài khoản}
\label{tab:mo-ta-uc01-dang-ky}
\\
\hline
...
\label{tab:mo-ta-uc02-dang-nhap}
\\
\hline
...
\label{tab:mo-ta-uc03-dang-xuat}
\\
\hline
...
\textbf{Actor chính} & Người dùng đã đăng nhập \\
\hline

\textbf{Mô tả} &
Cho phép người dùng kết thúc phiên làm việc hiện tại và rời khỏi hệ thống một cách an toàn.
\\
\hline

\textbf{Tiền điều kiện} &
Người dùng đã đăng nhập và đang sở hữu access token hợp lệ.
\\
\hline

\textbf{Luồng chính} &
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=2pt]
    \item 1. Người dùng chọn chức năng Đăng xuất.
    \item 2. Client gửi yêu cầu POST đến endpoint \texttt{/api/auth/logout} kèm JWT.
    \item 3. Hệ thống kiểm tra tính hợp lệ của token.
    \item 4. Hệ thống xác nhận đăng xuất thành công.
    \item 5. Client xóa access token, thông tin phiên và chuyển người dùng về màn hình đăng nhập.
\end{itemize}
\\
\hline
...
\textbf{Luồng rẽ nhánh} &
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=2pt]
    \item 2a. Không có JWT $\rightarrow$ yêu cầu bị từ chối và chuyển người dùng về màn hình đăng nhập.
    \item 3a. JWT hết hạn hoặc không hợp lệ $\rightarrow$ client xóa phiên cục bộ và yêu cầu đăng nhập lại.
    \item 4a. API không phản hồi $\rightarrow$ client vẫn xóa thông tin phiên cục bộ và hiển thị thông báo phù hợp.
\end{itemize}
\\
\hline

\textbf{Hậu điều kiện} &
Thông tin phiên đăng nhập và access token được xóa khỏi client; người dùng không thể truy cập các chức năng yêu cầu xác thực cho đến khi đăng nhập lại.
\\
\hline
...
\caption{Mô tả Use Case Tạo đơn giao hàng}
\label{tab:mo-ta-uc14-tao-don}
\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
\begin{longtable}{|L{3cm}|L{11cm}|}
\caption{Mô tả Use Case Xác nhận đơn giao hàng}
\label{tab:mo-ta-uc16-xac-nhan-don}
\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
\begin{longtable}{|L{3cm}|L{11cm}|}
\caption{Mô tả Use Case Xem đơn hàng}
\label{tab:mo-ta-uc19-xem-don}
\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
\begin{longtable}{|L{3cm}|L{11cm}|}
\caption{Mô tả Use Case Chỉnh sửa đơn hàng}
\label{tab:mo-ta-uc20-chinh-sua-don}
\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
\begin{longtable}{|L{3cm}|L{11cm}|}
\caption{Mô tả Use Case Theo dõi giao hàng}
\label{tab:mo-ta-uc22-theo-doi-giao-hang}
\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
\begin{longtable}{|L{3cm}|L{11cm}|}
\caption{Mô tả Use Case Xác nhận giao hàng}
\label{tab:mo-ta-uc23-xac-nhan-giao-hang}
\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
\end{longtable}
\begin{longtable}{|L{3cm}|L{11cm}|}
\caption{Mô tả Use Case Đánh giá giao hàng}
\label{tab:mo-ta-uc24-danh-gia}
\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
\begin{longtable}{|L{3cm}|L{11cm}|}
\caption{Mô tả Use Case Chatbot AI}
\label{tab:mo-ta-uc25-chatbot}
\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
\caption{Use Case Diagram của Nhân viên điều phối}
\label{fig:use-case-nhan-vien-dieu-phoi}
\end{figure}

\textbf{Bảng mô tả các use case chính của Nhân viên điều phối}

\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case của Nhân viên điều phối}\\
\label{tab:mo-ta-uc-nhan-vien-dieu-phoi-01}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC31 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC31 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc31-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC32 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC32 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc32-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC33 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC33 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc33-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC34 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC34 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc34-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC35 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC35 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc35-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC36 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC36 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc36-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC37 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC37 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc37-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC38 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC38 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc38-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC39 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC39 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc39-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC40 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC40 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc40-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC41 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC41 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc41-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC42 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC42 của Nhân viên điều phối}\\
\label{tab:mo-ta-uc42-dieu-phoi}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
\caption{Use Case Diagram của Nhân viên vận hành trạm}
\label{fig:use-case-nhan-vien-van-hanh-tram}
\end{figure}
...
% ==================== UC43 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case của Nhân viên vận hành trạm}\\
\label{tab:mo-ta-uc-nhan-vien-van-hanh-tram-01}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC44 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC44 của Nhân viên vận hành trạm}\\
\label{tab:mo-ta-uc44-van-hanh-tram}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC45 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC45 của Nhân viên vận hành trạm}\\
\label{tab:mo-ta-uc45-van-hanh-tram}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC46 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC46 của Nhân viên vận hành trạm}\\
\label{tab:mo-ta-uc46-van-hanh-tram}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC47 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC47 của Nhân viên vận hành trạm}\\
\label{tab:mo-ta-uc47-van-hanh-tram}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC48 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC48 của Nhân viên vận hành trạm}\\
\label{tab:mo-ta-uc48-van-hanh-tram}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC49 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC49 của Nhân viên vận hành trạm}\\
\label{tab:mo-ta-uc49-van-hanh-tram}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC50 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC50 của Nhân viên vận hành trạm}\\
\label{tab:mo-ta-uc50-van-hanh-tram}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
\caption{Use Case Diagram của Quản lý logistic}
\label{fig:use-case-quan-ly-logistic}
\end{figure}

\textbf{Bảng mô tả các use case chính của Quản lý logistic}

\textbf{Ghi chú phiên bản:} Các UC51--UC64 dưới đây thuộc phạm vi nghiệp vụ mục tiêu của Quản lý Logistics. Trong phiên bản hiện tại, Backend mới cung cấp các API analytics; giao diện Dashboard Logistics, báo cáo và các thao tác quản lý trạm chưa được triển khai đầy đủ.
...
% =========================================================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case của Quản lý logistic}\\
\label{tab:mo-ta-uc-quan-ly-logistic-01}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
\textbf{Use Case ID} & UC43 \\
...
% =========================================================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC44 của Quản lý logistic}\\
\label{tab:mo-ta-uc44-quan-ly-logistic}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
\textbf{Use Case ID} & UC44 \\
...
% =========================================================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC45 của Quản lý logistic}\\
\label{tab:mo-ta-uc45-quan-ly-logistic}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
\textbf{Use Case ID} & UC45 \\
...
% =========================================================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC46 của Quản lý logistic}\\
\label{tab:mo-ta-uc46-quan-ly-logistic}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
\textbf{Use Case ID} & UC46 \\
...
% =========================================================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC47 của Quản lý logistic}\\
\label{tab:mo-ta-uc47-quan-ly-logistic}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
\textbf{Use Case ID} & UC47 \\
...
% =========================================================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC48 của Quản lý logistic}\\
\label{tab:mo-ta-uc48-quan-ly-logistic}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
\textbf{Use Case ID} & UC48 \\
...
% =========================================================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC49 của Quản lý logistic}\\
\label{tab:mo-ta-uc49-quan-ly-logistic}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
\textbf{Use Case ID} & UC49 \\
...
% =========================================================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC50 của Quản lý logistic}\\
\label{tab:mo-ta-uc50-quan-ly-logistic}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
\textbf{Use Case ID} & UC50 \\
...
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Trạng thái Use Case UC51--UC64 của Quản lý Logistics}\\
\label{tab:trang-thai-uc51-64-logistics}\\
\hline
\textbf{Use Case} & \textbf{Trạng thái phiên bản hiện tại} \\
\hline
UC51--UC59 & Có dữ liệu phân tích Backend ở mức cơ bản; chưa có Dashboard Logistics hoàn chỉnh. \\
\hline
UC60--UC61 & Có API trạm và sức chứa; chưa có giao diện quản lý Logistics riêng. \\
\hline
UC62--UC64 & Chưa có module tạo, quản lý và xuất báo cáo PDF/Excel/CSV. \\
\hline
\end{longtable}
...
\caption{Use Case Diagram của Quản trị viên hệ thống}
\label{fig:use-case-quan-tri-vien}
\end{figure}
...
% ==================== UC65 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case của Quản trị viên hệ thống}\\
\label{tab:mo-ta-uc-quan-tri-vien-01}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC70 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC70 của Quản trị viên hệ thống}\\
\label{tab:mo-ta-uc70-quan-tri-vien}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC75 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC75 của Quản trị viên hệ thống}\\
\label{tab:mo-ta-uc75-quan-tri-vien}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC79 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC79 của Quản trị viên hệ thống}\\
\label{tab:mo-ta-uc79-quan-tri-vien}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC80 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC80 của Quản trị viên hệ thống}\\
\label{tab:mo-ta-uc80-quan-tri-vien}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
...
% ==================== UC82 ====================
\begin{longtable}{|C{3cm}|L{11cm}|}
\caption{Mô tả Use Case UC82 của Quản trị viên hệ thống}\\
\label{tab:mo-ta-uc82-quan-tri-vien}\\
\hline
\textbf{Thành phần} & \textbf{Nội dung} \\
\hline
